...
RUN wget -O models/checkpoints/sd3_medium_incl_clips_t5xxlfp16.safetensors https://huggingface.co/stabilityai/stable-diffusion-3-medium/resolve/main/sd3_medium_incl_clips_t5xxlfp16.safetensors --header="Authorization: Bearer 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"
